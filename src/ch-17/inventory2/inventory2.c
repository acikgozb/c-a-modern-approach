...
struct part *find_part(int number) {
  ...
  // (2) Set the pointer to the next element in the list
  // (3) Keep traversing the list until the end is reached (NULL)
  // or the given number is smaller than an item's number.
